...
n.replace(RegExp((e.escape||i.escape||pt).source+"|"+c.source+"|"+(c===st?lt:pt).source+"|"+(e.evaluate||i.evaluate||pt).source+"|$","g"),function(t,r,e,o,i,c){e||(e=o),l+=n.slice(a,c).replace(vt,f),l+=r?"'+__e("+r+")+'":i?"';"+i+";__p+='":e?"'+((__t=("+e+"))==null?'':__t)+'":"",u||(u=i||rt.test(r||e)),a=c+t.length}),l+="';",p||(s="obj",u?l="w