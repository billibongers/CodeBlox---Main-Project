...
var deepEqual = _require.deepEqual;
var errorEqual = _require.errorEqual;
	...
	suite('tests', function (suite) {
		...
		suite('before and after', function (suite, test) {
			...
			test('test 1', function () {
				checks.push('test 1');
				deepEqual(checks, ['before - test 1 - part 1', 'before - test 1 - part 2', 'test 1']);
			});

			test('test 2', function () {
				checks.push('test 2');
				deepEqual(checks, ['before - test 1 - part 1', 'before - test 1 - part 2', 'test 1', 'after - test 1 - part 1', 'after - test 1 - part 2', 'before - test 2 - part 1', 'before - test 2 - part 2', 'test 2']);
			});
			...
			test('test 3', { before: before, after: after }, function () {
				checks.push('test 3');
				deepEqual(checks, ['before - test 1 - part 1', 'before - test 1 - part 2', 'test 1', 'after - test 1 - part 1', 'after - test 1 - part 2', 'before - test 2 - part 1', 'before - test 2 - part 2', 'test 2', 'after - test 2 - part 1', 'after - test 2 - part 2', 'only before - test 3 - part 1', 'only before - test 3 - part 2', 'before - test 3 - part 1', 'before - test 3 - part 2', 'test 3'], 'test 3 checks');
			});

			test('test 4', function () {
				checks.push('test 4');
				deepEqual(checks, ['before - test 1 - part 1', 'before - test 1 - part 2', 'test 1', 'after - test 1 - part 1', 'after - test 1 - part 2', 'before - test 2 - part 1', 'before - test 2 - part 2', 'test 2', 'after - test 2 - part 1', 'after - test 2 - part 2', 'only before - test 3 - part 1', 'only before - test 3 - part 2', 'before - test 3 - part 1', 'before - test 3 - part 2', 'test 3', 'only after - test 3 - part 1', 'only after - test 3 - part 2', 'after - test 3 - part 1', 'after - test 3 - part 2', 'before - test 4 - part 1', 'before - test 4 - part 2', 'test 4'], 'test 4 checks');
			});
		});
